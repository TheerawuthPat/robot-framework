...
choose file ROBOT1.png
    Choose File    xpath:/*[@id="ng-app"]/body/div/div[2]/div[1]/input[2]    ${CURDIR}/ROBOT1.png
choose file ROBOT2.png
    Choose File    xpath://*[@id="ng-app"]/body/div/div[2]/div[1]/input[2]    ${CURDIR}/ROBOT2.png
choose file ROBOT3.png
    Choose File    xpath://*[@id="ng-app"]/body/div/div[2]/div[1]/input[2]    ${CURDIR}/ROBOT3.png
